...
func init() {
	...
	cmd.Filebeat().PersistentFlags().AddGoFlag(flag.CommandLine.Lookup("systemTest"))
	cmd.Filebeat().PersistentFlags().AddGoFlag(flag.CommandLine.Lookup("test.coverprofile"))
}
